...
!!! Contribution: We treated the credit scoring task as a text classification task, using clients as texts and transactions as individual words.
...
Our method computes credit scores using transcational data,
